      ...
      <div id="home">
        ...
        <div className="home-content"> {/*column 2*/}
          ...
          <div className="desc">
            ...
            <p>Aspiring software/web developer who's self-motivated and enjoys programming and solving problems. My hobbies apart from writing code include drawing, DIY/amature electronics and cycling.</p>
